import svgPaths from "./svg-9roxthpz3g";
import imgRectangle from "figma:asset/400162ba6f2375a0e4a93122b078eedf45d07153.png";
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[56px] top-[262px] w-[397px]">
      <div className="font-['Arial:Bold',sans-serif] leading-[28px] min-w-full not-italic relative shrink-0 text-[#848484] text-[18px] w-[min-content]">
...
export default function Frame1() {
  return (
    <div className="bg-[#e3e3e3] relative size-full">
      <Frame4 />
      <Frame3 />
      <div className="absolute left-[389px] size-[693px] top-[-216px]" data-name="Rectangle">
